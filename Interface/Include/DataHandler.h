...
namespace ubpiontraj
{
   ...
   public:
      ...
      int FinalStateKey(FinalState::Type type);
      void AddFinalState(const FinalState& fstt);
   ...
   private:
      ...
      std::vector<int> m_fstt_nprd, m_fstt_typ;
      std::vector<std::vector<int>> m_fstt_prdpdg;
   };
}
